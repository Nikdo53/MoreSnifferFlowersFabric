...
public class ModMenuTypes {
    ...
    public static final RegistryObject<MenuType<RebrewingStandMenu>> REBREWING_STAND = MENU_TYPES.register("rebrewing_stand", () -> new MenuType<>(RebrewingStandMenu::new, FeatureFlags.REGISTRY.allFlags()));
